...
public class ZonedTime {
  ...
  private int minute;
  private int second;
  private TimeZonesUS timeZone;
  private boolean inDst;

  public ZonedTime(int hour, int minute, int second, TimeZonesUS timeZone, boolean inDst) {
    this.hour = hour;
    this.minute = minute;
    this.second = second;
  ...
  public TimeZonesUS getTimeZone() {
    return timeZone;
  }
  ...
  public ZonedTime convertTimeZone(TimeZonesUS newTimeZone, boolean inDst){
    return new ZonedTime(newTimeZone.getTZHour(timeZone.getUtcHour(getHour(), isInDst()), inDst), minute, second, newTimeZone, inDst);
  }

  public String toString(){
    return "" + getHour() + ":" + getMinute() + ":" + getSecond() + " (" + getTimeZone().getAbbreviation(isInDst()) + ") - " + getTimeZone().getTZCoin().name();
  }
